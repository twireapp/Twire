...
public class MiniController extends RelativeLayout implements IMiniController {
    ...
    public void setDarkMode() {
        RelativeLayout container = (RelativeLayout) findViewById(R.id.container_current);
        container.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.grey_950));

        TextView title = (TextView) findViewById(R.id.title_view);
        TextView subtitle = (TextView) findViewById(R.id.subtitle_view);

        title.setTextColor(ContextCompat.getColor(getContext(), R.color.white_text));
        subtitle.setTextColor(ContextCompat.getColor(getContext(), R.color.white_text_secondary));
